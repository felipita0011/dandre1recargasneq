...
;var W=window;
function X(a,b){this.v={};this.playerInfo={};this.videoTitle="";this.l=this.g=this.h=null;this.i=0;this.s=!1;this.m=[];this.j=null;this.B={};if(!a)throw Error("YouTube player element ID required.");this.id=sa(this);b=Object.assign({title:"video player",videoId:"",width:640,height:360},b||{});var c=document;if(a=typeof a==="string"?c.getElementById(a):a)if(W.yt_embedsEnableRsaforFromIframeApi&&Ab(),c=a.tagName.toLowerCase()==="iframe",b.host||(b.host=c?tb(a.src):"https://www.youtube.com"),this.h=new Ib(b),
c||(b=Jb(this,a),this.l=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.g=a,this.g.id||(this.g.id="widget"+sa(this.g)),V[this.g.id]=this,window.postMessage){this.j=new T;Kb(this);b=Y(this.h,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var f in Cb)Cb.hasOwnProperty(f)&&Lb(this,f)}}
...
if(!c)return this;this.j.subscribe(a,c);Mb(this,a);return this};
function Lb(a,b){b=b.split(".");if(b.length===2){var c=b[1];"player"===b[0]&&Mb(a,c)}}
p.destroy=function(){this.g&&this.g.id&&(V[this.g.id]=null);var a=this.j;a&&typeof a.dispose=="function"&&a.dispose();if(this.l){a=this.l;var b=this.g,c=b.parentNode;c&&c.replaceChild(a,b)}else(a=this.g)&&a.parentNode&&a.parentNode.removeChild(a);Z&&(Z[this.id]=null);this.h=null;this.g&&this.u&&this.g.removeEventListener("load",this.u);this.l=this.g=null};
function Nb(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.s?a.sendMessage(b):a.m.push(b)}
function Jb(a,b){var c=document.createElement("iframe");b=b.attributes;for(var d=0,f=b.length;d<f;d++){var k=b[d].value;k!=null&&k!==""&&k!=="null"&&c.setAttribute(b[d].name,k)}c.setAttribute("frameBorder","0");c.setAttribute("allowfullscreen","");c.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share");c.setAttribute("referrerPolicy","strict-origin-when-cross-origin");c.setAttribute("title","YouTube "+Y(a.h,"title"));(b=Y(a.h,"width"))&&
c.setAttribute("width",b.toString());(b=Y(a.h,"height"))&&c.setAttribute("height",b.toString());var e=Ob(a);e.enablejsapi=window.postMessage?1:0;window.location.host&&(e.origin=window.location.protocol+"//"+window.location.host);e.widgetid=a.id;window.location.href&&H(["debugjs","debugcss"],function(g){var h=window.location.href;var l=h.search(wb);b:{var m=0;for(var n=g.length;(m=h.indexOf(g,m))>=0&&m<l;){var q=h.charCodeAt(m-1);if(q==38||q==63)if(q=h.charCodeAt(m+n),!q||q==61||q==38||q==35)break b;
...
W.yt_embedsEnableIframeApiSendFullEmbedUrl&&(window.location.href&&(e.forigin=window.location.href),b=window.location.ancestorOrigins,e.aoriginsup=b===void 0?0:1,b&&b.length>0&&(e.aorigins=Array.from(b).join(",")),window.document.referrer&&(e.gporigin=window.document.referrer));a=""+Y(a.h,"host")+Pb(a)+"?"+vb(e);W.yt_embedsEnableIframeSrcWithIntent?(Sa(c,Oa(a)),c.sandbox.add("allow-presentation","allow-top-navigation")):c.src=a;return c}
p.G=function(){this.g&&this.g.contentWindow?this.sendMessage({event:"listening"}):clearInterval(this.i)};
function Kb(a){Qb(a.h,a,a.id);a.i=setInterval(a.G.bind(a),250);a.g&&(a.u=function(){clearInterval(a.i);a.i=setInterval(a.G.bind(a),250)},a.g.addEventListener("load",a.u))}
function Mb(a,b){a.B[b]||(a.B[b]=!0,Nb(a,"addEventListener",[b]))}
...
function Pb(a){if(W.yt_embedsEnableIframeApiVideoIdValidation){a=String(Y(a.h,"videoId"));if(a.includes("../"))throw Error("Invalid video id");return"/embed/"+a}return"/embed/"+Y(a.h,"videoId")}
function Ob(a){var b=Y(a.h,"playerVars");if(b){var c={},d;for(d in b)c[d]=b[d];b=c}else b={};window!==window.top&&document.referrer&&(b.widget_referrer=document.referrer.substring(0,256));if(a=Y(a.h,"embedConfig")){if(F(a))try{a=JSON.stringify(a)}catch(f){console.error("Invalid embed config JSON",f)}b.embed_config=a}return b}
function Rb(a,b){if(F(b)){for(var c in b)b.hasOwnProperty(c)&&(a.playerInfo[c]=b[c]);a.playerInfo.hasOwnProperty("videoData")&&(b=a.playerInfo.videoData,b.hasOwnProperty("title")&&b.title?(b=b.title,b!==a.videoTitle&&(a.videoTitle=b,a.g.setAttribute("title",b))):(a.videoTitle="",a.g.setAttribute("title","YouTube "+Y(a.h,"title"))))}}
function Sb(a,b){H(b,function(c){this[c]||(c==="getCurrentTime"?this[c]=function(){var d=this.playerInfo.currentTime;if(this.playerInfo.playerState===1){var f=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;f>0&&(d+=Math.min(f,1))}return d}:Gb(c)?this[c]=function(){this.playerInfo={};
this.v={};Nb(this,c,arguments);return this}:Hb(c)?this[c]=function(){var d=0;
c.search("get")===0?d=3:c.search("is")===0&&(d=2);return this.playerInfo[c.charAt(d).toLowerCase()+c.substr(d+1)]}:this[c]=function(){Nb(this,c,arguments);
return this})},a)}
p.getVideoEmbedCode=function(){var a=Y(this.h,"host")+Pb(this),b=Number(Y(this.h,"width")),c=Number(Y(this.h,"height"));if(isNaN(b)||isNaN(c))throw Error("Invalid width or height property");b=Math.floor(b);c=Math.floor(c);var d=this.videoTitle;a=Ta(a);d=Ta(d!=null?d:"YouTube video player");return'<iframe width="'+b+'" height="'+c+'" src="'+a+'" title="'+(d+'" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>')};
...
function Ib(a){this.g=a||{};a=[this.g,window.YTConfig||{}];for(var b=0;b<a.length;b++)a[b].host&&(a[b].host=a[b].host.toString().replace("http://","https://"))}
function Y(a,b){a=[a.g,window.YTConfig||{}];for(var c=0;c<a.length;c++){var d=a[c][b];if(d!==void 0)return d}return null}
function Qb(a,b,c){Z||(Z={},Tb=new Set,Ub.addEventListener("message",function(d){a:if(Tb.has(d.origin)){try{var f=JSON.parse(d.data)}catch(g){break a}var k=Z[f.id];if(k&&d.origin===k.O)switch(d=k.U,d.s=!0,d.s&&(H(d.m,d.sendMessage,d),d.m.length=0),k=f.event,f=f.info,k){case "apiInfoDelivery":if(F(f))for(var e in f)f.hasOwnProperty(e)&&(d.v[e]=f[e]);break;case "infoDelivery":Rb(d,f);break;case "initialDelivery":F(f)&&(clearInterval(d.i),d.playerInfo={},d.v={},Sb(d,f.apiInterface),Rb(d,f));break;default:d.j.i||
(e={target:d,data:f},d.j.H(k,e),Fb("player."+k,e))}}}));
a=String(Y(a,"host"));Z[c]={U:b,O:a};Tb.add(a)}
function Vb(a){if(a.tagName.toLowerCase()!=="iframe"){var b=Eb(a,"videoid");b&&(b={videoId:b,width:Eb(a,"width"),height:Eb(a,"height")},new X(a,b))}}
var Z=null,Tb=null,Ub=window;G("YT.PlayerState.UNSTARTED",-1);G("YT.PlayerState.ENDED",0);G("YT.PlayerState.PLAYING",1);G("YT.PlayerState.PAUSED",2);G("YT.PlayerState.BUFFERING",3);G("YT.PlayerState.CUED",5);G("YT.get",function(a){return V[a]});
G("YT.scan",Db);G("YT.subscribe",function(a,b,c){U.subscribe(a,b,c);Cb[a]=!0;for(var d in V)V.hasOwnProperty(d)&&Lb(V[d],a)});
G("YT.unsubscribe",function(a,b,c){qb(a,b,c)});
G("YT.Player",X);X.prototype.destroy=X.prototype.destroy;X.prototype.setSize=X.prototype.setSize;X.prototype.getIframe=X.prototype.getIframe;X.prototype.addEventListener=X.prototype.addEventListener;X.prototype.getVideoEmbedCode=X.prototype.getVideoEmbedCode;X.prototype.getOptions=X.prototype.getOptions;X.prototype.getOption=X.prototype.getOption;
